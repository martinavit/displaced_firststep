...
void Analysis_tables::analisi(int num_histo_kin
    ...
    for(int sam = 0, effsam = 0; sam < nSamples; ++sam, ++effsam){
        ...
        for (Long64_t it = 0; it < nEntries; ++it){
            ...
            right_lepton.selezione(_gen_nL,_nL,  _lPt  , _lEta  , _lE  ,  _lPOGMedium  ,  _lPOGLoose ,_lFlavor  , _lCharge  , _relIso  , _dxy  , _dz  , _3dIP  , _3dIPSig  ,  _lIsPrompt,  prov_index,prov_number_tight,prov_number_prompt,skip_event, effsam, faxtore, _lpassConversionVeto,   _muNumberInnerHits,_eleNumberInnerHitsMissing,  _sumChargedHadronPt03);
            tightC = 0;
            ...
            if (skip_event[0] == 20  ){
                if (ossf_event)  counters_cut_ossf[9] = counters_cut_ossf[9] + 1*scal;
                if (!ossf_event)  counters_cut_no_ossf[9] = counters_cut_no_ossf[9] + 1*scal;
            }
            //=============================================================
            ...
            if (skip_event[0] == 20  ){
                if (ossf_event)  counters_cut_ossf[10] = counters_cut_ossf[10] + 1*scal;
                if (!ossf_event)  counters_cut_no_ossf[10] = counters_cut_no_ossf[10] + 1*scal;
            }
        ...
        cout<<"OSSF ------------- "<< 100<<"  "<< 100*counters_cut_ossf[1]/counters_cut_ossf[2]<<"  "<< 100*counters_cut_ossf[2]/counters_cut_ossf[2]<<"  "<< 100*counters_cut_ossf[3]/counters_cut_ossf[2]<<"  "<< 100*counters_cut_ossf[4]/counters_cut_ossf[2]<<"  "<< 100*counters_cut_ossf[5]/counters_cut_ossf[2]<<"  "<< 100*counters_cut_ossf[6]/counters_cut_ossf[2]<<"  "<< 100*counters_cut_ossf[7]/counters_cut_ossf[2]<<"  "<< 100*counters_cut_ossf[8]/counters_cut_ossf[2]<<"  "<< 100*counters_cut_ossf[9]/counters_cut_ossf[2]<<endl;
        ...
        cout<<"NO OSSF ************ "<< 100<<"  "<< 100*counters_cut_no_ossf[1]/counters_cut_no_ossf[2]<<"  "<< 100*counters_cut_no_ossf[2]/counters_cut_no_ossf[2]<<"  "<< 100*counters_cut_no_ossf[3]/counters_cut_no_ossf[2]<<"  "<< 100*counters_cut_no_ossf[4]/counters_cut_no_ossf[2]<<"  "<<100* counters_cut_no_ossf[5]/counters_cut_no_ossf[2]<<"  "<<100* counters_cut_no_ossf[6]/counters_cut_no_ossf[2]<<"  "<< 100*counters_cut_no_ossf[7]/counters_cut_no_ossf[2]<<"  "<< 100*counters_cut_no_ossf[8]/counters_cut_no_ossf[2]<<"  "<< 100*counters_cut_no_ossf[9]/counters_cut_no_ossf[2]<<endl;
        cout<<"----------"<<endl;
...
/*
 //==================================================================
 double Analysis_tables::fakeWeight(const unsigned ind, const int flavors, const double conePt, const double eta, const bool tight, TH2D* frMap, const unsigned lCount){
 unsigned nFO = 0;
 double fr[4];
